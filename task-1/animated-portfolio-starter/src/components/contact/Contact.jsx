...
const Contact = () => {
    return (
		...
		C501.071,340.717,512,299.589,512,256C511.98,114.604,397.389,0.012,255.998,0.002z" pathLength="1" stroke-dashoffset="0px" stroke-dasharray="1px 1px"></motion.path></svg>
                </motion.div>
